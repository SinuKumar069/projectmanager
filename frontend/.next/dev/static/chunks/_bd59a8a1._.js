...
function AuthGuard({ children }) {
    _s();
    const { isLoggedIn, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(AuthGuard, "NbfBNs6r7w2kjxkakJP0ZG66HdE=", false, function() {
    return [
...
_s(CreateProjectDialog, "Q24sGJu/P7keZXfPreD+WSQjjWE=");
...
const projectsApi = {
    ...
    getProjectById: async (projectId)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get(`/projects/${projectId}`);
        return response.data;
    },
    createProject: async (data)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post('/projects', data);
        return response.data;
    },
    updateProject: async (projectId, data)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].put(`/projects/${projectId}`, data);
        return response.data;
    },
    deleteProject: async (projectId)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].delete(`/projects/${projectId}`);
        return response.data;
    },
    getProjectMembers: async (projectId)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].get(`/projects/${projectId}/members`);
        return response.data;
    },
    addMember: async (projectId, data)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].post(`/projects/${projectId}/members`, data);
        return response.data;
    },
    updateMemberRole: async (projectId, userId, newRole)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].put(`/projects/${projectId}/members/${userId}`, {
            newRole
        });
        return response.data;
    },
    deleteMember: async (projectId, userId)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiClient"].delete(`/projects/${projectId}/members/${userId}`);
        return response.data;
    }
};
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
"[project]/components/projects/projects-list.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/button.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/client/app-dir/link.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$projects$2f$create$2d$project$2d$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/projects/create-project-dialog.tsx [app-client] (ecmascript)");
...
function ProjectsList() {
    ...
    const loadProjects = async ()=>{
        ...
        setError(null);
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$projects$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectsApi"].getProjects();
    ...
    const handleCreateProject = async (data)=>{
        try {
            const newProject = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$projects$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["projectsApi"].createProject(data);
...
_s(ProjectsList, "1x9BBh1I3c3rKtza7QcEbykT3co=");
_c = ProjectsList;
var _c;
...
//# sourceMappingURL=_bd59a8a1._.js.map